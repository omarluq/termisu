...
- [ ] **Run `bin/hace spec` and `bin/hace ameba` to verify all changes pass.** Pay attention to any resize-related or mode-change-related specs to ensure no regressions.
