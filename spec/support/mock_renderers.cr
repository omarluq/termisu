# Mock renderers for testing terminal components without real TTY access.
#
# Provides configurable mock implementations of Termisu::Renderer for testing
# buffer rendering, state tracking, and attribute handling.
...
# Terminal-like renderer with caching behavior for testing state management.
#
# Unlike MockRenderer which just tracks calls, CaptureTerminal actually
...
# terminal.foreground = Termisu::Color.red # No-op due to caching
# terminal.writes.size.should eq(1)
# ```
