...
describe Termisu::Event::Mouse::Button do
  describe ".from_cb" do
    context "basic buttons" do
      it "decodes 0 as Left button" do
        Termisu::Event::Mouse::Button.from_cb(0).should eq(Termisu::Event::Mouse::Button::Left)
      end

      it "decodes 1 as Middle button" do
        Termisu::Event::Mouse::Button.from_cb(1).should eq(Termisu::Event::Mouse::Button::Middle)
      end

      it "decodes 2 as Right button" do
        Termisu::Event::Mouse::Button.from_cb(2).should eq(Termisu::Event::Mouse::Button::Right)
      end

      it "decodes 3 as Release" do
        Termisu::Event::Mouse::Button.from_cb(3).should eq(Termisu::Event::Mouse::Button::Release)
      end
    end

    context "wheel events" do
      it "decodes 64 as WheelUp" do
        Termisu::Event::Mouse::Button.from_cb(64).should eq(Termisu::Event::Mouse::Button::WheelUp)
      end

      it "decodes 65 as WheelDown" do
        Termisu::Event::Mouse::Button.from_cb(65).should eq(Termisu::Event::Mouse::Button::WheelDown)
      end

      it "decodes 66 as WheelLeft" do
        Termisu::Event::Mouse::Button.from_cb(66).should eq(Termisu::Event::Mouse::Button::WheelLeft)
      end

      it "decodes 67 as WheelRight" do
        Termisu::Event::Mouse::Button.from_cb(67).should eq(Termisu::Event::Mouse::Button::WheelRight)
      end
    end
    ...
    context "extended buttons" do
      ...
      it "decodes 128 as basic button (extended not implemented)" do
        ...
        result = Termisu::Event::Mouse::Button.from_cb(128)
        result.should be_a(Termisu::Event::Mouse::Button)
      end
    end
    ...
    context "with modifier bits set" do
      ...
      it "decodes button correctly with Shift bit (4)" do
        Termisu::Event::Mouse::Button.from_cb(4).should eq(Termisu::Event::Mouse::Button::Left)
      end

      it "decodes button correctly with Alt bit (8)" do
        Termisu::Event::Mouse::Button.from_cb(8).should eq(Termisu::Event::Mouse::Button::Left)
      end

      it "decodes button correctly with Ctrl bit (16)" do
        Termisu::Event::Mouse::Button.from_cb(16).should eq(Termisu::Event::Mouse::Button::Left)
      end

      it "decodes button correctly with all modifier bits (28)" do
        Termisu::Event::Mouse::Button.from_cb(28).should eq(Termisu::Event::Mouse::Button::Left)
      end

      it "decodes middle button with modifiers" do
        Termisu::Event::Mouse::Button.from_cb(5).should eq(Termisu::Event::Mouse::Button::Middle) # 1 + 4 (Shift)
      end

      it "decodes right button with modifiers" do
        Termisu::Event::Mouse::Button.from_cb(10).should eq(Termisu::Event::Mouse::Button::Right) # 2 + 8 (Alt)
      end
    end
    ...
    context "with motion bit set" do
      ...
      it "decodes button correctly with motion bit" do
        Termisu::Event::Mouse::Button.from_cb(32).should eq(Termisu::Event::Mouse::Button::Left)
      end

      it "decodes middle button with motion" do
        Termisu::Event::Mouse::Button.from_cb(33).should eq(Termisu::Event::Mouse::Button::Middle)
      end

      it "decodes wheel up with motion" do
        Termisu::Event::Mouse::Button.from_cb(96).should eq(Termisu::Event::Mouse::Button::WheelUp) # 64 + 32
      end
    end
    ...
    context "unknown codes" do
      it "decodes high bits gracefully" do
        ...
        result = Termisu::Event::Mouse::Button.from_cb(255)
        result.should eq(Termisu::Event::Mouse::Button::WheelRight)
      end
    end
  end
  ...
  describe "predicate methods" do
    it "wheel_up? returns true for WheelUp" do
      Termisu::Event::Mouse::Button::WheelUp.wheel_up?.should be_true
      Termisu::Event::Mouse::Button::WheelDown.wheel_up?.should be_false
    end

    it "wheel_down? returns true for WheelDown" do
      Termisu::Event::Mouse::Button::WheelDown.wheel_down?.should be_true
      Termisu::Event::Mouse::Button::WheelUp.wheel_down?.should be_false
    end
  end
end
...
describe Termisu::Event::Mouse do
  describe ".new" do
    it "creates a mouse event with coordinates" do
      event = Termisu::Event::Mouse.new(10, 20, Termisu::Event::Mouse::Button::Left)
    ...
    it "creates a mouse event with modifiers" do
      ...
      event = Termisu::Event::Mouse.new(5, 5, Termisu::Event::Mouse::Button::Left, mods)
      event.modifiers.ctrl?.should be_true
      event.modifiers.shift?.should be_true
    end

    it "creates a mouse event with motion" do
      event = Termisu::Event::Mouse.new(5, 5, Termisu::Event::Mouse::Button::Left, Termisu::Input::Modifier::None, true)
  ...
  describe "#press?" do
    it "returns true for button press events" do
      left = Termisu::Event::Mouse.new(1, 1, Termisu::Event::Mouse::Button::Left)
      middle = Termisu::Event::Mouse.new(1, 1, Termisu::Event::Mouse::Button::Middle)
      right = Termisu::Event::Mouse.new(1, 1, Termisu::Event::Mouse::Button::Right)
    ...
    it "returns false for release events" do
      event = Termisu::Event::Mouse.new(1, 1, Termisu::Event::Mouse::Button::Release)
    ...
    it "returns true for wheel events (wheel is treated as instant press)" do
      ...
      up = Termisu::Event::Mouse.new(1, 1, Termisu::Event::Mouse::Button::WheelUp)
      down = Termisu::Event::Mouse.new(1, 1, Termisu::Event::Mouse::Button::WheelDown)
  ...
  describe "#wheel?" do
    it "returns true for wheel up" do
      event = Termisu::Event::Mouse.new(1, 1, Termisu::Event::Mouse::Button::WheelUp)
      event.wheel?.should be_true
    end

    it "returns true for wheel down" do
      event = Termisu::Event::Mouse.new(1, 1, Termisu::Event::Mouse::Button::WheelDown)
      event.wheel?.should be_true
    end

    it "returns true for wheel left" do
      event = Termisu::Event::Mouse.new(1, 1, Termisu::Event::Mouse::Button::WheelLeft)
      event.wheel?.should be_true
    end

    it "returns true for wheel right" do
      event = Termisu::Event::Mouse.new(1, 1, Termisu::Event::Mouse::Button::WheelRight)
      event.wheel?.should be_true
    end
  ...
  describe "modifier shortcuts" do
    it "#ctrl? returns true when Ctrl is pressed" do
      event = Termisu::Event::Mouse.new(1, 1, Termisu::Event::Mouse::Button::Left, Termisu::Input::Modifier::Ctrl)
      event.ctrl?.should be_true
      event.shift?.should be_false
    end

    it "#alt? returns true when Alt is pressed" do
      event = Termisu::Event::Mouse.new(1, 1, Termisu::Event::Mouse::Button::Left, Termisu::Input::Modifier::Alt)
      event.alt?.should be_true
      event.ctrl?.should be_false
    end

    it "#shift? returns true when Shift is pressed" do
      event = Termisu::Event::Mouse.new(1, 1, Termisu::Event::Mouse::Button::Left, Termisu::Input::Modifier::Shift)
  ...
  describe "coordinate handling" do
    it "handles large coordinates (SGR protocol)" do
      ...
      event = Termisu::Event::Mouse.new(500, 1000, Termisu::Event::Mouse::Button::Left)
    ...
    it "handles coordinate 223 (max for normal protocol)" do
      event = Termisu::Event::Mouse.new(223, 223, Termisu::Event::Mouse::Button::Left)
  ...
  describe "motion events" do
    it "creates drag event (motion with button pressed)" do
      event = Termisu::Event::Mouse.new(10, 10, Termisu::Event::Mouse::Button::Left, Termisu::Input::Modifier::None, true)
      event.motion?.should be_true
      event.button.should eq(Termisu::Event::Mouse::Button::Left)
    end
    ...
    it "creates hover event (motion with no button)" do
      ...
      event = Termisu::Event::Mouse.new(
        10, 10, Termisu::Event::Mouse::Button::Release, Termisu::Input::Modifier::None, true
      )
      event.motion?.should be_true
  ...
  describe "button-specific operations" do
    ...
    it "identifies middle click" do
      event = Termisu::Event::Mouse.new(1, 1, Termisu::Event::Mouse::Button::Middle)
      event.button.middle?.should be_true
    end

    it "identifies right click" do
      event = Termisu::Event::Mouse.new(1, 1, Termisu::Event::Mouse::Button::Right)
