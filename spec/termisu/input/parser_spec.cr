...
private def parse_sequence(bytes : Bytes) : Termisu::Event?
  ...
  describe "#poll_event" do
    context "printable characters" do
      it "parses lowercase letters" do
        ...
        event.should be_a(Termisu::Events::Key)
    ...
    context "SGR mouse protocol" do
      it "parses left click (\\e[<0;10;20M)" do
        ...
        event.should be_a(Termisu::Events::Mouse)
      ...
      it "parses middle click (\\e[<1;5;5M)" do
        ...
        event.should be_a(Termisu::Events::Mouse)
        if event.is_a?(Termisu::Events::Mouse)
          event.button.should eq(Termisu::Events::MouseButton::Middle)
        end
      end
      ...
      it "parses right click (\\e[<2;5;5M)" do
        ...
        event.should be_a(Termisu::Events::Mouse)
        if event.is_a?(Termisu::Events::Mouse)
          event.button.should eq(Termisu::Events::MouseButton::Right)
        end
      end
      ...
      it "parses wheel up (\\e[<64;10;10M)" do
        ...
        event.should be_a(Termisu::Events::Mouse)
        if event.is_a?(Termisu::Events::Mouse)
          event.button.should eq(Termisu::Events::MouseButton::WheelUp)
      ...
      it "parses wheel down (\\e[<65;10;10M)" do
        ...
        event.should be_a(Termisu::Events::Mouse)
        if event.is_a?(Termisu::Events::Mouse)
          event.button.should eq(Termisu::Events::MouseButton::WheelDown)
        end
      end
